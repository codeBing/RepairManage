...
{
    public class RepairSystemContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<RepairSystem.Models.RepairSystemContext>());
